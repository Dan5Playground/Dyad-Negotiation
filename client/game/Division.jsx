...
export default class Division extends React.Component {
    ...
    handleDrop = e => {
        const {isDeck, isSelf, stage, player, room } = this.props;
        ...
        console.log("player " + player.name + " released " + item + " back to room " + room);
        ...
        let targetName = "Undecided";
        if (!isDeck)
        {
        console.log("name is "+ room.split("-")[0]);
            targetName = room.split("-")[0];
        }
    ...
    render() {
        ...
        negoIssues.forEach(issue => {
            ...
            _.times(issue.quantity, i => {
                ...
                nameValPair[objName+i.toString()] = issue.value;
        ...
        return (
            ...
            >
                ...
                {isSelf && !isDeck ?
                    ...
                    {"Yours (Your current score is : "+ totalScore + " )"}</h6>:null}
